---
layout: project
title: Steel Bridge 2025-2026
description: I'm a member of the Cornell University Steel Bridge Project Team, and we compete in the annual ASCE Steel Bridge Competition. We design, analyze, fabricate, and construct steel bridges like these every year. 
technologies: [STAAD, Fusion360]
image: /assets/images/SteelBridge1.JPG

---


## Cornell Steel Bridge Project

As a member of Cornell's Steel Bridge Team, I participated in the design, fabrication, and construction of a competition bridge for the annual American Institute of Steel Construction (AISC) Student Steel Bridge Competition. The competition challenges students to design a lightweight, economical, and structurally efficient bridge while satisfying strict construction and loading requirements. Throughout the year, our team worked through the complete engineering process, from conceptual design and structural analysis to fabrication and final assembly.

During the design phase, our team developed a bridge configuration that balanced stiffness, constructability, and weight. Structural behavior was evaluated using finite element modeling in STAAD, where we analyzed member forces, deflections, and overall bridge performance under the prescribed loading conditions. The results of these analyses guided design decisions regarding member sizing, connection details, and overall geometry. By iterating through multiple design alternatives, we optimized the bridge to maximize structural efficiency while remaining practical to fabricate and assemble.
...
At competition, our team successfully assembled the bridge in 26 minutes, including all assessed penalties. Following construction, the bridge underwent load testing to evaluate its stiffness and structural performance. Our team's design and preparation resulted in strong performances across multiple categories, earning:
